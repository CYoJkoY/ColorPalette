(() => {
  ...
  const EXTRA = {
    'Palette relationships':'Color Relationships','Palette Studio':'Palette Studio','Hue':'Hue','Saturation':'Saturation','Lightness':'Lightness',
    'Discover':'Discover','Extract':'Extract','Create':'Create','Favorites':'Favorites','Workspace':'Workspace','Home':'Home',
    'No matching colors found.':'No matching colors found.','No colors extracted yet.':'No colors extracted yet.','No recent colors yet.':'No recent colors yet.',
    'Save Palette':'Save Palette','New Palette':'New Palette','Add Current Color':'Add Current Color','Current Palette':'Current Palette',
    'Extraction Results':'Extraction Results','Choose Image':'Choose Image','Clear':'Clear','Reload':'Reload','Copied':'Copied','Copy':'Copy','Delete':'Delete','Edit':'Edit','Remove':'Remove','Use':'Use',
    'Favorite Color':'Favorite Color','Unfavorite':'Unfavorite','Image Palette':'Image Palette','Pick Again':'Pick Again','Open Studio':'Open Studio','Open Color Library':'Open Color Library','Add to Palette':'Add to Palette','Back':'Back','Next':'Next','Previous':'Previous',
    'Light mode':'Light mode','Dark mode':'Dark mode','Switch to light mode':'Switch to light mode','Switch to dark mode':'Switch to dark mode',
    'Analogous':'Analogous','Complementary':'Complementary','Split Complementary':'Split Complementary','Triadic':'Triadic','Tetradic':'Tetradic','Double Complementary':'Double Complementary',
    'Warm Range':'Warm Range','Cool Range':'Cool Range','Monochromatic':'Monochromatic','Tints':'Tints','Shades':'Shades','Tones':'Tones','Pastel':'Pastel','Vivid':'Vivid','Warm':'Warm','Cool':'Cool','Grayscale':'Grayscale',
    'Color Parameters':'Color Parameters','Color Relationships':'Color Relationships','Nearby Colors':'Nearby Colors','Lightness Scale':'Lightness Scale','Perceptual Lightness Scale':'Perceptual Lightness Scale','Contrast':'Contrast','Contrast Check':'Contrast Check','White background':'White background','Black background':'Black background','OKLab distance':'OKLab distance',
    'Custom Color':'Custom Color','Custom':'Custom','Unknown':'Unknown','User input':'User input','Use in Studio':'Use in Studio','Favorited':'Favorited','Copy HEX':'Copy HEX','My Palettes':'My Palettes','Recent Colors':'Recent Colors','Color Relationship':'Color Relationship','Palette Name':'Palette name','Add Color':'Add Color','Copy values':'Copy values'
  };
